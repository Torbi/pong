...
public class PongGUI extends Application implements IEventHandler {
    ...
    private void newGame() {
        ...
        Ball ball = new Ball(GAME_WIDTH / 2 - Ball.WIDTH / 2, GAME_HEIGHT / 2 - Ball.HEIGHT / 2);
        Paddle rightPaddle = new Paddle(GAME_WIDTH - Paddle.PADDLE_WIDTH - 5, GAME_HEIGHT / 2 - Paddle.PADDLE_HEIGHT / 2);
        Paddle leftPaddle = new Paddle(Paddle.PADDLE_WIDTH + 5, GAME_HEIGHT / 2 - Paddle.PADDLE_HEIGHT / 2);
